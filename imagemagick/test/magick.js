...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 6874784,
    DYNAMIC_BASE = 6874784,
    DYNAMICTOP_PTR = 1631872;
...
// {{PRE_LIBRARY}}
  ...
  var ___tm_current=1631728;
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 1631776, 4), 1631776);function _gmtime_r(time, tmPtr) {
...
function nullFunc_iiijj(x) { err("Invalid function pointer called with signature 'iiijj'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");  err("Build with ASSERTIONS=2 for more info.");abort(x) }
...
function nullFunc_jjii(x) { err("Invalid function pointer called with signature 'jjii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");  err("Build with ASSERTIONS=2 for more info.");abort(x) }
...
function nullFunc_viidddddddd(x) { err("Invalid function pointer called with signature 'viidddddddd'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");  err("Build with ASSERTIONS=2 for more info.");abort(x) }
...
function nullFunc_viiiiiiiiiiiii(x) { err("Invalid function pointer called with signature 'viiiiiiiiiiiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");  err("Build with ASSERTIONS=2 for more info.");abort(x) }
...
var asmLibraryArg = {
  ...
  "nullFunc_viidddddddd": nullFunc_viidddddddd,
